(() => {
  ...
  const translations = {
    ...
    ar: {
      ...
      products: {
        ...
        p2:
          "ستتطور محفظة منتجاتنا مع تطور المنظومة، من التجارب الرقمية والأدوات الذكية إلى المنصات والمشاريع القابلة للتوسع.",
  ...
  function applyLanguage(language) {
    ...
    try {
      ...
      /* Storage unavailable — website continues normally. */
    }
